...
const p_booleanTemplate7 = (rowData, { rowIndex }) => <p >{String(rowData.isActive)}</p>
...
<Column field="isActive" header="IsActive" body={p_booleanTemplate7} filter={selectedFilterFields.includes("isActive")} hidden={selectedHideFields?.includes("isActive")}  style={{ minWidth: "8rem" }} />
